...
import { CheckCircle2, AlertCircle, Clock, ShoppingCart } from 'lucide-react';
...
const StatusPage: React.FC<{ type: 'success' | 'error' | 'pending' }> = ({ type }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-20 text-center animate-in zoom-in duration-500">
      <div className="bg-white dark:bg-gray-800 rounded-[3rem] p-12 shadow-xl border border-gray-100 dark:border-gray-700 max-w-lg mx-auto">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-10 font-medium">{content.msg}</p>
        <Link to="/" className="inline-block bg-gray-900 dark:bg-amber-400 dark:text-gray-900 text-white px-10 py-4 rounded-2xl font-black hover:bg-amber-500 transition-all shadow-lg">
          Voltar para a Home
        </Link>
      </div>
    </div>
...
const NotificationToast: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-[100] animate-in slide-in-from-bottom-10 fade-in duration-500">
      <div className="bg-gray-900 dark:bg-gray-800 text-white px-8 py-5 rounded-[2rem] shadow-2xl flex items-center space-x-4 border border-gray-800 dark:border-gray-700">
...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-[#0a0c10] text-gray-900 dark:text-gray-100 transition-colors duration-300 relative">
      <Navbar />
      <NotificationToast />
      ...
      <footer className="bg-white dark:bg-[#0f1115] border-t border-gray-100 dark:border-gray-800 py-16 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-500 dark:text-gray-400 max-w-sm mx-auto md:mx-0 font-medium leading-relaxed">
                {settings.storeTagline}
              </p>
            </div>
            <div>
              <h4 className="font-black text-xs uppercase tracking-widest text-gray-900 dark:text-white mb-6">Informações</h4>
              <ul className="space-y-3 text-gray-500 dark:text-gray-400 text-sm font-bold">
          ...
          <div className="border-t border-gray-50 dark:border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest gap-4">
